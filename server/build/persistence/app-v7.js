...
const buildId = (key, date) => {
    const dateFormatted = date
        ...
        .replace(/-/g, '')
        .slice(0, 6);
    return `${key}${dateFormatted}`; // Buffer.from(`${key}${dateFormatted}`, 'hex');
};
...
const bulkUpsert = (docs) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return mdb_1.default.collections.appV7.bulkWrite(upsertOperations, { ordered: false });
});
...
const getReport = (filter) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const [result] = yield mdb_1.default.collections.appV7.aggregate(pipeline).toArray();
    return result;
});
